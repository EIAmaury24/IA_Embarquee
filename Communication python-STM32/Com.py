...
def evaluate_model_on_STM32(iterations, serial_port):
    ...
    for i in range(iterations):
        ...
        print("L'output est là en dessous")
        print(output)
...
if __name__ == '__main__':
    X_test = np.load("./Colab_IA_EMBARQUEE/modele_usine_X.npy")
    Y_test = np.load("./Colab_IA_EMBARQUEE/modele_usine_Y.npy")
