...
#include "colab_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_COLAB_MODEL_NAME          "colab"
#define AI_COLAB_ORIGIN_MODEL_NAME   "modele_usine"

/******************************************************************************/
#define AI_COLAB_ACTIVATIONS_ALIGNMENT   (4)
#define AI_COLAB_INPUTS_IN_ACTIVATIONS   (4)
#define AI_COLAB_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_COLAB_IN_NUM        (1)

AI_DEPRECATED
#define AI_COLAB_IN \
  ai_colab_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_COLAB_IN_SIZE { \
  AI_COLAB_IN_1_SIZE, \
}
#define AI_COLAB_IN_SIZE_BYTES { \
  AI_COLAB_IN_1_SIZE_BYTES, \
}
#define AI_COLAB_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_COLAB_IN_1_CHANNEL     (5)
#define AI_COLAB_IN_1_SIZE        (5)
#define AI_COLAB_IN_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_COLAB_OUT_NUM       (1)

AI_DEPRECATED
#define AI_COLAB_OUT \
  ai_colab_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_COLAB_OUT_SIZE { \
  AI_COLAB_OUT_1_SIZE, \
}
#define AI_COLAB_OUT_SIZE_BYTES { \
  AI_COLAB_OUT_1_SIZE_BYTES, \
}
#define AI_COLAB_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_COLAB_OUT_1_CHANNEL     (5)
#define AI_COLAB_OUT_1_SIZE        (5)
#define AI_COLAB_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_COLAB_N_NODES (8)
 ...
 * @ref ai_colab_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_colab_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_COLAB_*
 * defines into file @ref colab.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
